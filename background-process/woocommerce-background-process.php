    ...
    class WooCommerce_Background_Process extends WP_Background_Process
    {
        ...
        private function get_json_data($controller)
        {
            ...
            if ($controller === 'inventoryitem')
                ...
                $item_count = 100;
            $headers = array(
                'MachineId: ' . '7527a0ac-1e9e-4e16-8c31-013e3cec5689',//get_option('machine_id'),
                'MachineKey: ' . '40D4A01FE2884A79835DA9D3467AE18B',//get_option('machine_key'),
                'IntegratorId: ' . 'F437556E-688F-4296-B8CB-7E023C666C8D',//get_option('integrator_id'),
